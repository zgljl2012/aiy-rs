...
if __name__ == '__main__':
    ...
    #     "stabilityai/stable-diffusion-xl-base-1.0", torch_dtype=torch.float16
    # )
    vae = AutoencoderKL(in_channels=3, out_channels=3, down_block_types=[], up_block_types=[],
                        block_out_channels=[], layers_per_block=1, act_fn='silu', latent_channels=4,
                        norm_num_groups=32, sample_size=32, scaling_factor=0.18215, force_upcast=True)
